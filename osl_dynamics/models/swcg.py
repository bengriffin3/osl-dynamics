"""Sliding Window Correlation Generative Model (SWCG) with a Multivariate Normal observation model.

Conceptually, SWCG is the same as the classical sliding window correlation model, but implemented
in a Bayesian way very similar to HMM.
Ideally, SWCG can include haemodynamic response function and autocorrelation function if needed.
"""
...
class Config(BaseModelConfig):
    ...
    n_channels : int
        Number of channels.
    window_length: int
        The length of the window in SWC.
    window_offset: int
        The number of steps to move forward after calculation
    learn_means : bool
