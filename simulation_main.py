...
if __name__ == '__main__':
    ...
    ### Update 5th October 2024
    ### Generate sliding window correlation, use real covariances trained from HMM, very noisy.
    save_dir = './data/node_timeseries/simulation_bicv/real_swc_very_very_noisy/'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    if not os.path.exists(f'{save_dir}truth/'):
        os.makedirs(f'{save_dir}truth')
    ...
    import shutil
    save_dir = './data/node_timeseries/simulation_bicv/hrf/'
    ...
    ### Generate simulation using TPM and covariances with 50 channels, 8 states
    ### Convolve that with hrf
    '''
    from osl_dynamics.array_ops import apply_hrf
    save_dir = './data/node_timeseries/simulation_bicv/real_hrf_50/'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    if not os.path.exists(f'{save_dir}truth/'):
        os.makedirs(f'{save_dir}truth')
    ...
    covs = np.load('./results_HCP_bicv_202410/ICA_50/hmm_check/hmm_ICA_50_state_8/repeat_1/inf_params/covs.npy')
    for i in range(len(covs)):
        covs[i] = (covs[i] + covs[i].T) / 2
    ...
    ### No HRF involved
    '''
    save_dir = './data/node_timeseries/simulation_bicv/real_50/'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    if not os.path.exists(f'{save_dir}truth/'):
        os.makedirs(f'{save_dir}truth')
    ...
    ### Generate simulation using covariances with 50 channels, 8 states, but apply very stable TPM
    ### Apply HRF
    from osl_dynamics.array_ops import apply_hrf
    save_dir = './data/node_timeseries/simulation_bicv/real_hrf_50_stable/'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    if not os.path.exists(f'{save_dir}truth/'):
        os.makedirs(f'{save_dir}truth')
    ...
    ### Generate simulation using random covariances with 50 channels, 8 states,apply very stable TPM
    ### Apply HRF
    from osl_dynamics.array_ops import apply_hrf

    save_dir = './data/node_timeseries/simulation_bicv/random_hrf_50_stable/'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    if not os.path.exists(f'{save_dir}truth/'):
        os.makedirs(f'{save_dir}truth')
    ...
    save_dir = './data/node_timeseries/simulation_bicv/random_hrf_50/'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    if not os.path.exists(f'{save_dir}truth/'):
        os.makedirs(f'{save_dir}truth')
    ...
    ### Generate sliding window correlation, use randomly generated covariances
    ### the window length is 15
    save_dir = './data/node_timeseries/simulation_bicv/swc_50_random/'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    if not os.path.exists(f'{save_dir}truth/'):
        os.makedirs(f'{save_dir}truth')
    ...
    save_dir = './data/node_timeseries/simulation_bicv/swc_50_random_stable/'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    if not os.path.exists(f'{save_dir}truth/'):
        os.makedirs(f'{save_dir}truth')
    ...
    save_dir = './data/node_timeseries/simulation_bicv/random_first_hrf_50/'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    if not os.path.exists(f'{save_dir}truth/'):
        os.makedirs(f'{save_dir}truth')
    covariances = np.load('./results_simulation_bicv_202407/random_hrf_50/hmm_check/hmm_ICA_50_state_8/repeat_1/inf_params/covs.npy')
    tpm = np.load('./results_HCP_bicv_202410/ICA_50/hmm_check/hmm_ICA_50_state_8/repeat_1/model/trans_prob.npy')
    ...
    save_dir = './data/node_timeseries/simulation_bicv/random_dynemo_fair_new_3/'
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    if not os.path.exists(f'{save_dir}truth/'):
        os.makedirs(f'{save_dir}truth')
